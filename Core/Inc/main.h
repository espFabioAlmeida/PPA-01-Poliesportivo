...
#define DISPLAY3_DATAC8_Pin GPIO_PIN_8
#define DISPLAY3_DATAC8_GPIO_Port GPIOC
#define DISPLAY3_CLOCKC9_Pin GPIO_PIN_9
#define DISPLAY3_CLOCKC9_GPIO_Port GPIOC
